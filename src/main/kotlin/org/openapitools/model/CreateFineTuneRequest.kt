...
data class CreateFineTuneRequest(
    ...
    @Schema(example = "null", description = "The name of the base model to fine-tune. You can select one of \"ada\", \"babbage\", \"curie\", \"davinci\", or a fine-tuned model created after 2022-04-21. To learn more about these models, see the [Models](https://beta.openai.com/docs/models) documentation. ")
    @get:JsonProperty("model") val model: kotlin.String? = "curie",
    ...
    @get:JsonProperty("prompt_loss_weight") val promptLossWeight: java.math.BigDecimal? = BigDecimal("0.01"),
